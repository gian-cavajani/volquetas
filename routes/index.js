...
const { validateNuevoEmpleado, validateEmpleadoId } = require('../middleware/validarEmpleado');
...
module.exports = function () {
  ...
  router.put('/camiones/:camionId', verificarToken, camionController.actualizarCamion);
  ...
  router.get('/empleados/:empleadoId', verificarToken, validateEmpleadoId, empleadoController.getEmpleado);
  router.patch('/empleados/:empleadoId/estado', verificarTokenAdmin, validateEmpleadoId, empleadoController.cambiarEstadoEmpleado);
  router.delete('/empleados/:empleadoId', verificarTokenAdmin, validateEmpleadoId, empleadoController.eliminarEmpleado);
  ...
  router.get('/servicios/:camionId', verificarToken, servicioController.getServicioPorCamion);

  //Jornales
  router.post('/jornales', verificarToken, jornalController.nuevoJornal);
  router.get('/jornales/:jornalId', verificarToken, jornalController.getJornal);
  router.delete('/jornales/:jornalId', verificarTokenAdmin, jornalController.borrarJornal);
  router.put('/jornales/:jornalId', verificarTokenAdmin, jornalController.editarJornal);
